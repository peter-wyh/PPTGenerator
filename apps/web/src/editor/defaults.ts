  ...
  switch (type) {
    ...
    case 'bar-chart':
      return {
        ...
        bars: [
          { label: 'A', value: 0, color: 'auto' },
          { label: 'B', value: 0, color: 'auto' },
          { label: 'C', value: 0, color: 'auto' },
        ],
      };
    case 'line-chart':
      return {
    ...
    case 'creator-works-list':
      return {
        ...
        insights: [
          {
            topCities: [
              { label: '地区一', value: 0, color: 'auto' },
              { label: '地区二', value: 0, color: 'auto' },
              { label: '地区三', value: 0, color: 'auto' },
              { label: '地区四', value: 0, color: 'auto' },
            ],
            genderSplit: [
              { label: 'F', value: 0, color: 'auto' },
              { label: 'M', value: 0, color: 'auto' },
            ],
            ageRange: [
              { label: '18-24', value: 0, color: 'auto' },
              { label: '25-34', value: 0, color: 'auto' },
              { label: '35-44', value: 0, color: 'auto' },
              { label: '45+', value: 0, color: 'auto' },
            ],
            trend: [
              { label: 'D1', value: 0 },
              { label: 'D2', value: 0 },
    ...
    case 'creator-fan-gender':
      return {
        ...
        center: '--',
        slices: [
          { label: 'Female', value: 0, color: 'auto' },
          { label: 'Male', value: 0, color: 'auto' },
          { label: 'Other', value: 0, color: 'auto' },
        ],
      };
    case 'creator-fan-city':
      return {
        ...
        subtitle: '',
        bars: [
          { label: '城市一', value: 0, color: 'auto' },
          { label: '城市二', value: 0, color: 'auto' },
          { label: '城市三', value: 0, color: 'auto' },
          { label: '城市四', value: 0, color: 'auto' },
          { label: '城市五', value: 0, color: 'auto' },
          { label: '城市六', value: 0, color: 'auto' },
          { label: '城市七', value: 0, color: 'auto' },
          { label: '城市八', value: 0, color: 'auto' },
        ],
      };
    ...
    case 'creator-fan-interest':
      return {
        ...
        showPercent: true,
        tags: [
          { label: '兴趣一', value: 0, color: 'auto' },
          { label: '兴趣二', value: 0, color: 'auto' },
          { label: '兴趣三', value: 0, color: 'auto' },
          { label: '兴趣四', value: 0, color: 'auto' },
        ],
      };
    ...
    case 'campaign-analysis':
      return {
        ...
        dimensions: [
          { label: 'Reach', value: 0, max: 100 },
          { label: 'Engagement', value: 0, max: 100 },
          { label: 'Conversion', value: 0, max: 100 },
          { label: 'CPE', value: 0, max: 100 },
          { label: 'CVR', value: 0, max: 100 },
          { label: 'CPM', value: 0, max: 100 },
        ],
        funnelSteps: [
    ...
    case 'funnel-chart':
      return {
        ...
        steps: [
          { label: 'Impressions', value: 0, rate: '' },
          { label: 'Clicks', value: 0, rate: '' },
          { label: 'Add to Cart', value: 0, rate: '' },
          { label: 'Checkout', value: 0, rate: '' },
          { label: 'Purchase', value: 0, rate: '' },
        ],
        insight: '',
      };
    ...
    case 'placement-type-summary':
      return {
        ...
        items: [
          { type: '类型一', revenue: '--', revenueShare: '--', clicks: '--', ctr: '--', conversions: '--', cvr: '--', epc: '--', roas: '--', trend: Array.from({ length: 7 }, (_, i) => ({ label: `D${i}`, value: 0 })) },
          { type: '类型二', revenue: '--', revenueShare: '--', clicks: '--', ctr: '--', conversions: '--', cvr: '--', epc: '--', roas: '--', trend: Array.from({ length: 7 }, (_, i) => ({ label: `D${i}`, value: 0 })) },
          { type: '类型三', revenue: '--', revenueShare: '--', clicks: '--', ctr: '--', conversions: '--', cvr: '--', epc: '--', roas: '--', trend: Array.from({ length: 7 }, (_, i) => ({ label: `D${i}`, value: 0 })) },
          { type: '类型四', revenue: '--', revenueShare: '--', clicks: '--', ctr: '--', conversions: '--', cvr: '--', epc: '--', roas: '--', trend: Array.from({ length: 7 }, (_, i) => ({ label: `D${i}`, value: 0 })) },
        ],
      };
